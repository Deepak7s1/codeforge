...
public class SearchView extends Panel {
    ...
    private AddressBookTutorial app;

    public SearchView(final AddressBookTutorial app) {
        this.app = app;
        addStyleName("view");
    ...
    private void performSearch() {
        ...
        SearchFilter searchFilter =
            new SearchFilter(fieldToSearch.getValue(), searchTerm, (String)searchName.getValue());
        if (saveSearch.booleanValue()) {
            if (searchName.getValue() == null || searchName.getValue().equals("")) {
                getWindow().showNotification("Please enter a name for your search!",
